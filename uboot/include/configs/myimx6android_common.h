...
#ifndef MYIMX6_ANDROID_COMMON_H
#define MYIMX6_ANDROID_COMMON_H
...
#define CONFIG_FASTBOOT_MANUFACTURER_STR  "MYZR"
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "i.mx6 Evaluation Kit (DIMM200)"
